...
INSERT INTO employe (employee_name, department_name, salary, hire_date) VALUES 
...
SELECT salary from employe WHERE department_name = 'HR'; -- 63000

-- //! SELECT * from employees WHERE salary > 63000

SELECT * from employe WHERE salary > (SELECT max(salary) from employe WHERE department_name = 'HR')
